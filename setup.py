...
test_dependencies = ['django==1.11.29', 'django-tastypie==0.12.1', 'jsonpath', 'jmespath']
...
setup(name='pyresttest',
      ...
      author='refactored by Tamara Macul Mendes, based off Sam Van Oort pyresttest',
      ...
      py_modules=['pyresttest.resttest', 'pyresttest.generators', 'pyresttest.binding',
                  ...
                  'pyresttest.signer', 'pyresttest.metric'],
